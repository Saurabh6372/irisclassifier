...
It prints the accuracy and classification report, and saves the confusion matrix to `outputs/confusion_matrix.png` (the folder is created programmatically).
...
The test asserts the model reaches at least 90% accuracy on the test set.
